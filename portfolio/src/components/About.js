                ...
                <div className="about-summary">
                    <div className="summary-paper" >
                        <div className="quick-info">
                            <p>
                                Fullstack developer with knowledge knowledge on popular frameworks (React, Angular, ...), 
                                experience working on large projects and providing qualtiy work, 
                                and the ability to pick up new technologies rapidly.
                            </p>
                            <br/>
                        </div>
